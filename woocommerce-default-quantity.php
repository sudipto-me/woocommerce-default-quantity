...
class Default_Product_Quantity {
    ...
    public function wc_missing_notice() {
        if ( ! $this->is_wc_active() ) {
            $message = sprintf( __( '<strong>Default Product Quantity for WooCommerce</strong> requires <strong>WooCommerce</strong> installed and activated. Please Install %s WooCommerce. %s', 'woocommerce-product-default-quantity' ),
...
//
//        if ( is_admin() ) {
//            require_once dirname( __FILE__ ) . '/includes/admin/class-woocommerce-product-default-quantity-admin.php';
//        }
